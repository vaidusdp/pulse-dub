      ...
      <div className="w-full max-w-[440px] z-10 flex flex-col items-center">
        ...
        <div className="w-full text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm">
            Sign in to continue monitoring your application pulses.
          </p>
        </div>
